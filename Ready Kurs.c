...

{
        ...
        
    {
        ...
        
        {
            ...
            case 8:   //Сумма двух стеков
                if (!isEmpty(stackPtr1) && !isEmpty(stackPtr) )// Проверка на пустоту стэка
                {
    ...
    printf("Ведите номер элемента перед которым хотите вставить новый\n");
                int nn=0;
                int jj=0;
                scanf("%d %d",&nn,&jj);
...
printf("Ведите номер элемента после которого хотите вставить новый \n");
                int el=0;
                int znach=0;
                scanf("%d %d",&el,&znach);
                el++;
